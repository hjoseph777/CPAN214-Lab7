...
def render_page(title: str, body_markup: str) -> HttpResponse:
    """Render a basic HTML shell that pulls in our shared stylesheet."""
    html = f"""
    <!DOCTYPE html>
    <html lang=\"en\">
    <head>
...
def home(request):
    ...
    body = """
        ...
        <p class=\"footer-note\">Browse the sections above to see a themed greeting or the current server time.</p>
    """
